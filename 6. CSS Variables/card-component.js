class CardComponent extends HTMLElement {
  constructor() {
    ...
    <style>
    h3 {
      font-size: var(--card-name-font-sizecolor, 26px);
    }
    ...
    button {
      ...
      color: black; 
      border: 2px solid var(--button-color, var(--card-button-color, #4CAF50));
      padding: 16px 32px;
      text-align: center;
    ...
    button:hover {
      ...
      background-color: var(--button-color, var(--card-button-color, #4CAF50));
      color: white;
    }
